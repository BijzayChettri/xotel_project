    		 ...
    		 <div class="align-items-center text-center text-md-left svmobsearch desk-search-form container">
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img class="d-block w-100" src="{{ asset('front/images/banners/banner_1640077336.jpg') }}" alt="First slide">
                ...
                <div class="carousel-item ">
                  <img class="d-block w-100" src="{{ asset('front/images/banners/banner_1639745343.jpg') }}"  alt="First slide">
                    <div class="carousel-caption "> 
						                        <div class="sv_home_subsec text-center">
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/single-room-in-chennai-1.html" aria-label="single room in Chennai">
                                    <figure class="">
                                        <img src="{{ asset('images/property/70/1636187496_1629728681_barce1.jpg') }}  class="room-image-container200" alt="single room in Chennai"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/apartment-in-budapest-1.html" aria-label="Apartment in Budapest">
                                    <figure class="">
                                        <img src="{{ asset('images/property/55/1629730932_budapest1.jpg') }}" class="room-image-container200" alt="Apartment in Budapest"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/island-1.html" aria-label="Island">
                                    <figure class="">
                                        <img src="{{ asset('images/property/47/1629904717_13.jpg') }}" class="room-image-container200" alt="Island"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/shared-room-in-new-york-1.html" aria-label="Shared room in New York">
                                    <figure class="">
                                        <img src="{{ asset('images/property/4/1625484861_img4.jpg') }}"  class="room-image-container200" alt="Shared room in New York"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/home-in-singapore.html" aria-label="Home in  Singapore">
                                    <figure class="">
                                        <img src="{{ asset('images/property/63/1629989324_new14.jpg') }}"  class="room-image-container200" alt="Home in  Singapore"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/tent-house-in-new-york.html" aria-label="Tent House in New York">
                                    <figure class="">
                                    <img src="{{ asset('images/property/46/1629724316_ny7.jpg') }}"  class="room-image-container200" alt="Tent House in New York"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/private-house-in-paris.html" aria-label="Private House in Paris">
                                    <figure class="">
                                        <img src="{{ asset('images/property/52/1629903118_4.jpg') }}" class="room-image-container200" alt="Private House in Paris"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
