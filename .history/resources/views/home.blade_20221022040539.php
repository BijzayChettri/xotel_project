...
<!-- Mirrored from demowpthemes.com/buy2rental/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2022 15:25:07 GMT -->
...
<head>
		...
		<meta property="og:image"              content="public/front/images/banners/banner_1639745343.jpg" />


		
					<link rel="shortcut icon" href="public/front/images/logos/1628150085_favicon.png">
		
		<title>Home | Rental  Marketplace Script  </title>
    ...
    <link  rel="stylesheet" type="text/css" href="public/css/glyphicon.css"/>

		<link rel="preconnect" href="https://fonts.gstatic.com/">
		<link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet">
		<link rel="stylesheet" href="public/css/vendors/bootstrap/bootstrap.min.css">
		<link rel="stylesheet" href="public/css/vendors/fontawesome/css/all.min.css">
...
<input type="hidden" id="front_date_format_type" value="dd-mm-yy"> 
...
<div class="row sv_demo_mode">
	<div class="col-md-12">
		...
		<a href="https://demowpthemes.com/buy2rental"><span class="svrestore ml-4 rounded-4">Restore Now</span></a>
	</div>
</div>
<style>
.svrestore {
    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid container-fluid-90">
                <a class="navbar-brand logo_h d-none dark_logo" aria-label="logo" href="https://demowpthemes.com/buy2rental"><img src="public/front/images/logos/1628150190_logo.png" alt="logo" class="img-130x32"></a> 
            
               <a class="navbar-brand logo_h light_logo" aria-label="logo" href="https://demowpthemes.com/buy2rental"><img src="public/front/images/logos/1631535148_light_logo.png" alt="logo" class="img-130x32"></a> 

				<a class="navbar-brand logo_h d-block" aria-label="logo" href="https://demowpthemes.com/buy2rental"><img src="public/front/images/logos/1628150085_favicon.png" alt="logo" class="mob-logo"></a> 
		        ...
		        <form id="front-search-form1" method="post" action="https://demowpthemes.com/buy2rental/search" class="mob-search mt-3 mb-3 p-2">
					<input type="hidden" name="_token" value="EAkjyNL7f9cswZsM7zpd4HZYFXF14YwDW6IPhlYr">
					<div class="row">
						<input autocomplete="off" class="form-control p-3 text-14 ml-3 m-0" id="front-search-field1" placeholder="Where are you going?" name="location" type="text" value="" required>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <div class="nav navbar-nav menu_nav justify-content-end">
                            ...
                            -->
                            <div class="nav-item">
                                    <a class="nav-link p-2 mt-3" href="login.html" aria-label="property-create">
                                        <button class="btn button vbtn-default text-14 p-0 mt-2 pl-4 pr-4 br-50">
                                            <p class="p-3 mb-0">  Add your Space</p>
                                        </button>
                                    </a>
							...
							<a class="nav-link globe" href="#" aria-label="modalLanguge" data-toggle="modal" data-target="#languageModalCenter"> <i class="fa fa-globe text-18"></i> </a>
									...
									<div class="dropdown sv_user_login">
										<button class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-bars" aria-hidden="true"></i>
											<img src="public/images/profile.jpg" class="head_avatar" alt="">
										</button>
										
										<ul class="dropdown-menu">
										    										        <li><a  aria-label="" data-toggle="modal" data-target="#registermodel"  href="#">Sign Up</a></li>
                                            										    
										    										      <li><a aria-label="" data-toggle="modal" data-target="#loginmodel"  href="#">Log In</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class=" mb-5" >
			...
			<form id="login_form" method="post" action="https://demowpthemes.com/buy2rental/authenticate"  accept-charset='UTF-8'>  
				<input type="hidden" name="_token" value="EAkjyNL7f9cswZsM7zpd4HZYFXF14YwDW6IPhlYr">
				...
				<div class="form-group col-sm-12 p-0 mt-3" >
					<div class="d-flex justify-content-between">
						...
						<div class="m-3 text-14">
							<a href="#" class="forgot-password text-right" aria-label="" data-toggle="modal" data-target="#forgotmodel" data-dismiss="modal">Forgot password?</a>
						</div>
					</div>
				</div>
					...
					<button type='submit' id="" class="btn pb-3 pt-3  button-reactangular text-15 vbtn-success w-100 rounded"> <i class="spinner fa fa-spinner fa-spin d-none" ></i>
						<span id="btn_next-text" class="font-weight-700">Login</span>
							...
							<div id="sv_phone_div" class="hide">
							 ...
							 <form class="" id="otp_form" method="post" action="https://demowpthemes.com/buy2rental/sendotp"  accept-charset='UTF-8'>  
									<input type="hidden" name="_token" value="EAkjyNL7f9cswZsM7zpd4HZYFXF14YwDW6IPhlYr">
			...
			<!--<p class="text-center font-weight-700 mt-4">or</p>
    ...
    <div class="modal-content">
	 ...
	 <div class="modal-header">
      ...
      <div class="modal-body">
		...
		<div class="p-5 mb-5">
				<form id="signup_form" name="signup_form" method="post" action="https://demowpthemes.com/buy2rental/create" class='signup-form login-form' accept-charset='UTF-8' onsubmit="return ageValidate();">    
					<input type="hidden" name="_token" value="EAkjyNL7f9cswZsM7zpd4HZYFXF14YwDW6IPhlYr">
					<div class="row text-16">
						...
						<input type="hidden" name="carrier_code" id="carrier_code" class="form-control">
												...
												<div class="form-group col-sm-12 p-0">
														<input type="text" class='form-control text-14 p-2' value="" name='first_name' id='first_name' placeholder='First Name'>
						</div>

						<div class="form-group col-sm-12 p-0">
																<input type="text" class='form-control text-14 p-2' value="" name='last_name' id='last_name' placeholder='Last Name'>
						</div>

						<div class="form-group col-sm-12 p-0">
								<input type="text" class='form-control text-14 p-2' value="" name='email' id='email' placeholder='Email'>
						...
						<div class="form-group col-sm-12 p-0">
																<input type="password" class='form-control text-14 p-2' name='password' id='password' placeholder='Password'>
						</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <div class="mt-5" >
                  <div class="col-md-12">
                     	<form id="forgot_password_form" method="post" action="https://demowpthemes.com/buy2rental/forgot_password" class='signup-form login-form mt-3' accept-charset='UTF-8'>  
				             <input type="hidden" name="_token" value="EAkjyNL7f9cswZsM7zpd4HZYFXF14YwDW6IPhlYr">
				            <div class="form-group col-sm-12 p-0 mt-3">
    		 ...
    		 <div class="align-items-center text-center text-md-left svmobsearch desk-search-form container">
                            ...
                            <form id="front-search-form" method="post" action="https://demowpthemes.com/buy2rental/search">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control p-3 text-14" id="front-search-field" placeholder="Where are you going?" autocomplete="off" name="location" type="text" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 nopadding ">
                                        <div class="row" id="daterange-btn">
                                            <div class="col-md-6 col-6 mt-4 mt-md-0 mob-pd-0">
                                                ...
                                                <input class="form-control p-3  text-14 checkinout" name="checkin" id="startDate" type="text" placeholder="Add Dates" autocomplete="off" readonly="readonly" required>
                                            </div>
                                            <div class="col-md-6 col-6 mt-4 mt-md-0 mob-pd-0">
                                                <label>Check Out</label>
                                                <input class="form-control p-3 text-14 checkinout" name="checkout" id="endDate" placeholder="Add Dates" type="text" readonly="readonly" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-block d-sm-none front-search mt-2">
                                        <button type="submit" class="btn vbtn-default btn-block p-3 text-16"><i class="fa fa-search"></i> Search</button>
                                    </div>
                                </div>
                            </form>
                            </div>
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img class="d-block w-100" src="public/front/images/banners/banner_1640077336.jpg" alt="First slide">
                    <div class="carousel-caption "> 
                            ...
                            <h4 class="banner-title"> Experiences Local things to do, wherever you are. </h4>
							 <div align="center" class="flexible-btn mt-5">
								  <a class="btn pl-5 pr-5 text-16 btn vbtn-default br-50" onclick="getLocation()" href="#">I’m flexible</a>
							 </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item ">
                  <img class="d-block w-100" src="public/front/images/banners/banner_1639745343.jpg" alt="First slide">
                    <div class="carousel-caption "> 
						                        <div class="sv_home_subsec text-center">
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/single-room-in-chennai-1.html" aria-label="single room in Chennai">
                                    <figure class="">
                                        <img src="public/images/property/70/1636187496_1629728681_barce1.jpg" class="room-image-container200" alt="single room in Chennai"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                                ...
                                <div class="d-flex">
                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/single-room-in-chennai-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> single room in Chennai</p>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/apartment-in-budapest-1.html" aria-label="Apartment in Budapest">
                                    <figure class="">
                                        <img src="public/images/property/55/1629730932_budapest1.jpg" class="room-image-container200" alt="Apartment in Budapest"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                                ...
                                <div class="d-flex">
                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/apartment-in-budapest-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Apartment in Budapest</p>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/island-1.html" aria-label="Island">
                                    <figure class="">
                                        <img src="public/images/property/47/1629904717_13.jpg" class="room-image-container200" alt="Island"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/shared-room-in-new-york-1.html" aria-label="Shared room in New York">
                                    <figure class="">
                                        <img src="public/images/property/4/1625484861_img4.jpg" class="room-image-container200" alt="Shared room in New York"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                                ...
                                <div class="d-flex">
                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/shared-room-in-new-york-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Shared room in New York</p>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/home-in-singapore.html" aria-label="Home in  Singapore">
                                    <figure class="">
                                        <img src="public/images/property/63/1629989324_new14.jpg" class="room-image-container200" alt="Home in  Singapore"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                ...
                                <div class="review-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p class="text-13 mt-2 mb-0 text"><i class="fas fa-map-marker-alt"></i> Singapore</p>
                                        </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/tent-house-in-new-york.html" aria-label="Tent House in New York">
                                    <figure class="">
                                        <img src="public/images/property/46/1629724316_ny7.jpg" class="room-image-container200" alt="Tent House in New York"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                                ...
                                <div class="d-flex">
                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/tent-house-in-new-york.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Tent House in New York</p>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/private-house-in-paris.html" aria-label="Private House in Paris">
                                    <figure class="">
                                        <img src="public/images/property/52/1629903118_4.jpg" class="room-image-container200" alt="Private House in Paris"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                                ...
                                <div class="d-flex">
                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/private-house-in-paris.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Private House in Paris</p>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/hut-in-new-york-1.html" aria-label="Hut in New York">
                                    <figure class="">
                                        <img src="public/images/property/48/1629725388_ny9.jpg" class="room-image-container200" alt="Hut in New York"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
          ...
          success: function (data)
          {
            ...
            <div class="container-fluid container-fluid-90">
                ...
                <div class="row mt-3">
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/entire-homeapt-in-mangaluru-1.html" aria-label="Entire home/apt in Mangaluru">
                                    <figure class="">
                                        <img src="public/images/property/95/1641553446_grant-durr-ybVhYLhh1wA-unsplash_11zon.jpg" class="room-image-container200" alt="Entire home/apt in Mangaluru"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                <div class="d-flex">
                                                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/entire-homeapt-in-mangaluru-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Entire home/apt in Mangaluru </p>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="review-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p class="text-13 mt-2 mb-0 text"><i class="fas fa-map-marker-alt"></i> Mangaluru</p>
                                        </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/entire-homeapt-in-chennai-3.html" aria-label="Entire home/apt in Chennai">
                                    <figure class="">
                                        <img src="public/images/property/94/1641448503_relax-area-resort_11zon.jpg" class="room-image-container200" alt="Entire home/apt in Chennai"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                <div class="d-flex">
                                                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/entire-homeapt-in-chennai-3.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Entire home/apt in Chennai </p>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/entire-homeapt-in-mysuru-1.html" aria-label="Entire home/apt in Mysuru">
                                    <figure class="">
                                        <img src="public/images/property/91/1641451722_1641295180_Rental-Property-with-a-Strong-Foundation_11zon.jpg" class="room-image-container200" alt="Entire home/apt in Mysuru"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                <div class="d-flex">
                                                                    <div class="text">
                                        <a class="text-color text-color-hover" href="properties/entire-homeapt-in-mysuru-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Entire home/apt in Mysuru </p>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/appartment-in-chennai-1.html" aria-label="Appartment in Chennai">
                                    <figure class="">
                                        <img src="public/images/property/86/1638872074_beautiful-red-brick-house-with-decorative-lights_11zon.jpg" class="room-image-container200" alt="Appartment in Chennai"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                <div class="d-flex">
                                        ...
                                        <a class="text-color text-color-hover" href="properties/appartment-in-chennai-1.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Appartment in Chennai </p>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/private-room-in-bengaluru.html" aria-label="Private room in Bengaluru">
                                    <figure class="">
                                        <img src="public/images/property/73/1638425398_house-isolated-field.jpg" class="room-image-container200" alt="Private room in Bengaluru"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                            ...
                            <div class="card-body p-0 pl-1 pr-1">
                                <div class="d-flex">
                                        ...
                                        <a class="text-color text-color-hover" href="properties/private-room-in-bengaluru.html">
                                            <p class="text-14 font-weight-700 text margin-bottom-zero"> Private room in Bengaluru </p>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="review-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p class="text-13 mt-2 mb-0 text"><i class="fas fa-map-marker-alt"></i> Bengaluru</p>
                                        </div>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/single-room-in-budapest-1.html" aria-label="Single room in  Budapest">
                                    <figure class="">
                                        <img src="public/images/property/60/1629782423_budapest2.jpg" class="room-image-container200" alt="Single room in  Budapest"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
        ...
        <div class="container-fluid container-fluid-90">
            ...
            <div class="row mt-2 svcity">
                ...
                <a href="search919b.html?location=New%20York&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_1.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="searchb019.html?location=Sydney&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_2.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="searchc54e.html?location=Paris&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_3.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="search5459.html?location=Barcelona&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_4.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="searchb5dc.html?location=Berlin&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_5.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="searchf63b.html?location=Budapest&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_6.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="search80c3.html?location=Singapore&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_1627625434.jpg" alt="city"/>
                                    <figcaption>
                ...
                <a href="searcha01a.html?location=New%20Delhi&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                                <img src="public/front/images/starting_cities/starting_city_1627625602.jpg" alt="city"/>
                                    <figcaption>
        ...
        <div class="container-fluid container-fluid-90">
            <div class="row tryhosting" style="background:url(public/front/images/logos/1635917422_try_hosting_img.jpg);">
                <div class="col-md-12">
                     ...
                     <a href="become-host.html"><button class="p-3 rounded-4 border-0 font-weight-500 mt-5">Get Started</button></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col p-0">
                        <ul class="mt-1">
                                ...
                                <a href="search262c.html?location=New%20York&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">New York</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="searcha869.html?location=Sydney&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Sydney</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="searchffd5.html?location=Paris&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Paris</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="search8e1e.html?location=Barcelona&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Barcelona</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="search404d.html?location=Berlin&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Berlin</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="search073b.html?location=Budapest&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Budapest</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="searchb502.html?location=Singapore&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">Singapore</a>
                            </li>
                                                        <li class="pt-3 text-14">
                                <a href="search3f54.html?location=New%20Delhi&amp;checkin=09-03-2022&amp;checkout=09-03-2022&amp;guest=1">New Delhi</a>
                            </li>
                                                                                </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                              <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Language</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Currency</a>
                              </li>
...
<!-- New Js start-->
    ...
    <script type="text/javascript" src="public/js/front.min.js"></script>
    <script type="text/javascript" src="public/js/daterangecustom.js"></script>
    <script type="text/javascript">
        $(function() {
  ...
  geocoder.geocode({latLng: latlng}, function(results, status) {
    if (status == google.maps.GeocoderStatus.OK) {
      ...
      if (results[1]) {
        ...
        //console.log(results);
	    window.location = 'https://demowpthemes.com/buy2rental/search?location=' + results[1].formatted_address + '&checkin=&checkout=&guest=1';
