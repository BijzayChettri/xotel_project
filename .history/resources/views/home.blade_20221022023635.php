                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/entire-homeapt-in-mangaluru-1.html" aria-label="Entire home/apt in Mangaluru">
                                    <figure class="">
                                        <img src="{{ asset('images/property/95/1641553446_grant-durr-ybVhYLhh1wA-unsplash_11zon.jpg') }}" class="room-image-container200" alt="Entire home/apt in Mangaluru"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
                        ...
                        <div class="card h-100 card-shadow card-1">
                            <div class="">
                                <a href="properties/entire-homeapt-in-chennai-3.html" aria-label="Entire home/apt in Chennai">
                                    <figure class="">
                                        <img src="{{ asset('images/property/94/1641448503_relax-area-resort_11zon.jpg') }}" class="room-image-container200" alt="Entire home/apt in Chennai"/>
                                        <figcaption>
                                        </figcaption>     
                                    </figure>        
                                </a>
        ...
        <div class="container-fluid container-fluid-90">
            ...
            <div class="row mt-2 svcity">
                ...
                <a href="search80c3.html?location=Singapore&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                            <img src="{{ asset('front/images/starting_cities/starting_city_1627625434.jpg') }}" alt="city"/>
                                    <figcaption>
                ...
                <a href="searcha01a.html?location=New%20Delhi&amp;checkin=&amp;checkout=&amp;guest=1">
                        <div class="grid item animated zoomIn">
                            <figure class="effect-ming">
                            <img src="{{ asset('front/images/starting_cities/starting_city_1627625602.jpg') }}" alt="city"/>
                                    <figcaption>
