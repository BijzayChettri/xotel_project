...
<!-- Mirrored from demowpthemes.com/buy2rental/become-host by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2022 15:29:35 GMT -->
<!-- Added by HTTrack -->
...
<head>
	...
	<meta property="og:title" content="Become Host" />
	<meta property="og:description" content="" />
	<meta property="og:image"
		content="https://demowpthemes.com/buy2rental/public/front/images/banners/banner_1639745343.jpg" />
...
<body>
	...
	<header class="header_area  animated fadeIn migrateshop_othernav">
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid container-fluid-90">
					<a class="navbar-brand logo_h d-none dark_logo" aria-label="logo"
						href="https://demowpthemes.com/buy2rental"><img
							src="public/front/images/logos/1628150190_logo.png" alt="logo" class="img-130x32"></a>

					<a class="navbar-brand logo_h light_logo" aria-label="logo"
						href="https://demowpthemes.com/buy2rental"><img
							src="public/front/images/logos/1631535148_light_logo.png" alt="logo" class="img-130x32"></a>

					<a class="navbar-brand logo_h d-block" aria-label="logo"
						href="https://demowpthemes.com/buy2rental"><img
							src="public/front/images/logos/1628150085_favicon.png" alt="logo" class="mob-logo"></a>
					...
					<form id="front-search-form1" method="post" action="https://demowpthemes.com/buy2rental/search"
						...
						<div class="row">
							<input autocomplete="off" class="form-control p-3 text-14 ml-3 m-0" id="front-search-field1"
								placeholder="Where are you going?" name="location" type="text" value="" required>
							...
							<div class="nav-item">
								<div class="dropdown sv_user_login">
									...
									<ul class="dropdown-menu">
										...
										<li><a aria-label="" data-toggle="modal" data-target="#loginmodel" href="#">Log
												In</a></li>
					...
					<ul class="mobile-side">
						...
						<li>
							...
							<a href="#" aria-label="modalCurrency" data-toggle="modal"
								data-target="#currencyModalCenter"> <span class="ml-4">&#36; - <u>USD</u> </span></a>
						</li>
							...
							<form id="signup_form" name="signup_form" method="post"
								...
								<div class="row text-16">
									...
									<input type="hidden" name="formatted_phone" id="formatted_phone"
										class="form-control">
									<div class="form-group col-sm-12 p-0">
										<input type="text" class='form-control text-14 p-2' value="" name='first_name'
											id='first_name' placeholder='First Name'>
									</div>

									<div class="form-group col-sm-12 p-0">
										<input type="text" class='form-control text-14 p-2' value="" name='last_name'
		...
		<div>
					...
					<div class="container">
						<div align="center" class="col-ms-12">
							<div class="join_banner_txt">
								...
								<h4>anywhere</h4>
								<button class="btn green-theme-btn">Get Started</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div data-testid="how-it-works-section">
						<div class="SectionSteps_root__2NGjK SectionSteps_root--gray__2vZS6">
							<div class="Container_root__1WntK">
								<div>
									<h1 class="SectionSteps_title__3JXIX text-center font-weight-700">Safety On Rent
									</h1>
								</div>
									...
									<div class="SectionSteps_stepsInner__3OYc8 row">
										<div class="SectionSteps_stepRoot__mCrpV text-center col-md-4">
											<div class="SectionSteps_stepHeader__3LkpP">
												...
												<h2 class="SectionSteps_stepTitle__MXOfF font-weight-600">5,00,000 host
													guarantee</h2>
											</div>

											<p class="SectionSteps_stepBody__1oiml">Lorem Ipsum has been the industry
												standard dummy text ever since the 1500s, when an unknown printer took a
												galley of type and scrambled it to book.</p>
										</div>
										...
										<div class="SectionSteps_stepRoot__mCrpV text-center col-md-4">
											<div class="SectionSteps_stepHeader__3LkpP">
												...
												<h2 class="SectionSteps_stepTitle__MXOfF font-weight-600">Host
													Protection Insurance</h2>
											</div>
										...
										<div class="SectionSteps_stepRoot__mCrpV text-center col-md-4">
											<div class="SectionSteps_stepHeader__3LkpP">
												...
												<h2 class="SectionSteps_stepTitle__MXOfF font-weight-600">Rent is built
													on trust</h2>
											</div>
					...
					<div class="container">
						<div class="row">
							<div class="recommandedhead section-intro text-center mt-70">
								<p class="animated fadeIn text-24 text-color font-weight-700 m-0">We&rsquo;ll help you
									bring the art of hosting to life</p>
							...
							<div data-v-3601cef9="">
								<div class="operators-page__how__item" data-v-3601cef9="">
									<div class="operators-page__how__text" data-v-3601cef9="">
										<div class="operators-page__how__title" data-v-3601cef9=""><span
												class="operators-page__how__index" data-v-3601cef9="">1. </span> Create
											your account</div>

										<div class="start-content">This will take less than 5 minutes
											of&nbsp;your&nbsp;time</div>
									</div>
								...
								<div class="operators-page__how__item" data-v-3601cef9="">
									<div class="operators-page__how__text" data-v-3601cef9="">
										<div class="operators-page__how__title" data-v-3601cef9=""><span
												class="operators-page__how__index" data-v-3601cef9="">2. </span> Create
											your listing</div>

										<div class="start-content">Lorem Ipsum has been the industry standard dummy text
											ever since the 1500s, when an unknown printer took a galley of type and
											scrambled it to book.</div>
									</div>
								...
								<div class="operators-page__how__item" data-v-3601cef9="">
									<div class="operators-page__how__text" data-v-3601cef9="">
										<div class="operators-page__how__title" data-v-3601cef9=""><span
												class="operators-page__how__index" data-v-3601cef9="">3. </span> Get
											Paid</div>
			...
			<section class="faq-sec">
				<div class="container">
					<div class="row">
						<div class="recommandedhead text-center col-md-12">
							<p class="animated fadeIn text-24 text-color font-weight-700 m-0">Frequently asked questions
							</p>
						</div>
						...
						<div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2">
							<ul class="faq-list">
								<li>
									...
									<p class="read faq-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Morbi aliquam, felis quis viverra mattis, quam mi elementum ipsum, lacinia
										blandit ipsum massa a elit. Suspendisse metus ex, porta ut velit vitae, sagittis
										dapibus sapien. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
										mollis maximus sem, id malesuada neque porta id. Praesent scelerisque molestie
										mollis. Integer nec ullamcorper massa.</p>
								</li>
								<li>
								...
								<li>
									<h4 class="faq-heading font-weight-600">Does Rent provide any insurance for hosts?
									</h4>
				...
				<div class="container">
					<div align="center" class="col-ms-12">
						<div class="more-qn-sec">
							...
							<p class="mt-md-5">Contact us at <a class="green-theme-font"
									href="mailto:support@migrateshop.com">support@migrateshop.com</a></p>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<a href="https://demowpthemes.com/buy2rental"><img
									src="public/front/images/logos/1628150190_logo.png" class="img-130x32"
									alt="logo"></a>
						</div>
					</div>
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
											role="tab" aria-controls="home" aria-selected="true">Language</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile"
											role="tab" aria-controls="profile" aria-selected="false">Currency</a>
									</li>
									...
									<div class="tab-pane fade" id="profile" role="tabpanel"
										...
										<div class="row">
											<div class="col-6 col-sm-3 mt-5 p-3">
												<div
													class="currency pl-3 pr-3 text-16 border rounded-5 currency-active">
	...
	<section class="footer-fixed-nav d-block d-sm-none">
		<ul>
			<li><a class="" href="https://demowpthemes.com/buy2rental"><i class="fab fa-wpexplorer"
						aria-hidden="true"></i>
...
<!-- Mirrored from demowpthemes.com/buy2rental/become-host by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2022 15:29:38 GMT -->
