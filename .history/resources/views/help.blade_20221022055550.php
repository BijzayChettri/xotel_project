...
<body>
        ...
        <div class="container-fluid container-fluid-90 ">
            ...
            <ul>
                <li>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi aliquam, felis quis viverra
                        mattis, quam mi elementum ipsum, lacinia blandit ipsum massa a elit. Suspendisse metus ex, porta
                        ut velit vitae, sagittis dapibus sapien. Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit. Nulla mollis maximus sem, id malesuada neque porta id. Praesent scelerisque molestie
    ...
    */
    ...
    <script type="text/javascript"
        src='https://maps.google.com/maps/api/js?key=AIzaSyBjxknPFQxYv3j5xWuNgNISwaFIdSPVp_I&amp;libraries=places'>
    </script>
    <script type="text/javascript">
    $(function() {
